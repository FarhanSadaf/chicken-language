...
| Trigonometry | <ul><li>***PI***<br/>The keyword PI `π` returns the ratio of a circle’s circumference to its diameter.<br/>`print PI;` `Output: 3.141593`</li><br/><li>***sin(x)***<br/>Returns the sine of an argument (angle in degree).<br/>`print sin(90);` `Output: 1`<br/><br/>***asin(x)***<br/>It takes a single argument (-1 ≤ x ≤ -1), and returns the arc sine (inverse of sin) in degrees.<br/>`print asin(0.5);` `Output: 30`</li><br/><li>***cos(x)***<br/>Returns the cosine of an argument (angle in degree).<br/>`print cos(90);` `Output: 0`<br/><br/>***acos(x)***<br/>It takes a single argument (-1 ≤ x ≤ -1), and returns the arc cosine (inverse of cosine) in degrees.<br/>`print acos(0.5);` `Output: 60`</li><br/><li>***tan(x)***<br/>Returns the tangent of an argument (angle in degree).<br/>`print tan(45);` `Output: 1`<br/><br/>***atan(x)***<br/>It takes a single argument, and returns the arc tangent (inverse of tangent) in degrees.<br/>`print atan(0.5);` `Output: 26.565051`</li></ul> |
